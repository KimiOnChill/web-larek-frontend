...
- `countAmount(): number` - считает и возвращает количество товаров в корзине для использования этого значения в счетчике.
- `countTotalPrice(): number` - считает и возвращает суммарную стоимость товаров в корзине.
